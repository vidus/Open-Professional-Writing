...
/**
 * USAGE:
 * 1 - To use this file replace "openstudent" with the name of
...
// Replace 'openstudent' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function openstudent_form_system_theme_settings_alter(&$form, &$form_state)  {
