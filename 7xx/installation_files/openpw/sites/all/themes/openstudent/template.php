 ...
 * 1. Rename each function and instance of "openstudent" to match
 *    your subthemes name, e.g. if your theme name is "footheme" then the function
 *    name will be "footheme_preprocess_hook". Tip - you can search/replace
 *    on "openstudent".
 * 2. Uncomment the required function to use.
 * 3. Read carefully, especially within openstudent_preprocess_html(), there
 ...
 */
function openstudent_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'openstudent.responsive.style.css',
    'openstudent.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'openstudent');
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'openstudent');
  // */
...
function openstudent_process_html(&$vars) {
}
// */
...
function openstudent_preprocess_page(&$vars) {
}

function openstudent_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function openstudent_preprocess_node(&$vars) {
}

function openstudent_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function openstudent_preprocess_comment(&$vars) {
}

function openstudent_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function openstudent_preprocess_block(&$vars) {
}

function openstudent_process_block(&$vars) {
}
// */
