...
/**
 * USAGE:
 * 1 - To use this file replace "openinstructor" with the name of
...
// Replace 'openinstructor' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function openinstructor_form_system_theme_settings_alter(&$form, &$form_state)  {
