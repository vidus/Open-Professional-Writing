 ...
 * 1. Rename each function and instance of "openinstructor" to match
 *    your subthemes name, e.g. if your theme name is "footheme" then the function
 *    name will be "footheme_preprocess_hook". Tip - you can search/replace
 *    on "openinstructor".
 * 2. Uncomment the required function to use.
 * 3. Read carefully, especially within openinstructor_preprocess_html(), there
 ...
 */
function openinstructor_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'openinstructor.responsive.style.css',
    'openinstructor.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'openinstructor');
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'openinstructor');
  // */
...
function openinstructor_process_html(&$vars) {
}
// */
...
function openinstructor_preprocess_page(&$vars) {
}

function openinstructor_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function openinstructor_preprocess_node(&$vars) {
}

function openinstructor_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function openinstructor_preprocess_comment(&$vars) {
}

function openinstructor_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function openinstructor_preprocess_block(&$vars) {
}

function openinstructor_process_block(&$vars) {
}
// */
